...
import { Mail, Phone, Twitter, Facebook, Linkedin, MapPin, PhoneCall } from "lucide-react";
import Image from "next/image";
import Link from "next/link";
import assets from "@/assets";
      ...
      <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8">
        ...
        <div className="flex flex-col gap-2  text-foreground">
          <Link href="/" className="flex items-center gap-2  text-primary">
            <Image src={assets.svg.logo} width={40} height={40} alt="logo" className="text-primary" />
            <span className="text-xl">ShareNest</span>
          </Link>
          <p className="flex items-center gap-2  text-foreground">
            <MapPin className="h-4 w-4" />
            <span className="text-md  text-foreground">Parbatipur, Dinajpur</span>
          </p>
          <p className="flex items-center gap-2  text-foreground">
            <Mail className="h-4 w-4" />
            <span className="text-md">sobujapm87@gmail.com</span>
